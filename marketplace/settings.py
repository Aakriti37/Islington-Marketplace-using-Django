...
SECRET_KEY = 'django-insecure-2bar&hquf06ftrb4^a1-mtbf_v4@^4zw(ohng@ujo00cyi2+#6'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'templates copy')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
CSRF_TRUSTED_ORIGINS = [
    'https://islington-marketplace-using-django.onrender.com',
]
